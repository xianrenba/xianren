...
function optionsframework_options() {
    ...
    $options[] = array(
		'name' => __('header选项', 'haoui').' (轻语博客加强版)',
		'id' => 'header_style',
		'std' => "2",
		'type' => "select",
...
*/
	...
	$options[] = array(
  	...
  	$options[] = array(
		'name' =>__('全屏查看图片模式', 'haoui').'(轻语博客加强版)',
		'id' => 'full_image',
		'desc' => __('开启', 'haoui'),
		'std' => true,
		'type' => "checkbox");
    ...
    $options[] = array(
		'name' =>__('启用文章列表页面滚动动画', 'haoui').'(轻语博客加强版)',
		'id' => 'switch_wow',
		'desc' => __('开启', 'haoui'),
		'std' => true,
		'type' => "checkbox");
	...
	$options[] = array(
		'name' => __('文章图片延时加载', 'haoui').'(轻语博客加强版)',
		'id' => 'post_loading',
		'type' => "checkbox",
		'std' => true,
  ...
  $options[] = array(
   ...
   $options[] = array(
    ...
    $options[] = array(
		...
		'id' => 'alipay_key',
		'type' => 'text',
		'desc' => __('支付宝商家身份Key, 请至<a href="https://b.alipay.com" target="_blank">支付宝商家服务</a>进行申请', 'haoui'));
...
/*
	...
	$options[] = array(
	    ...
	    'desc' => __('显示首页滚动公告', 'haoui').'(轻语博客加强版)',
	    'type' => 'checkbox');
	...
	/*$options[] = array(
        ...
        'id' => 'dux_tui',
        'std' => '<li>欢迎访问轻语博客，WordPress信息，WordPress教程，热点搞笑分享</li><li>DUX轻语博客加强版主题现已支持滚动公告栏功能，兼容其他浏览器，看到的就是咯，在后台最新消息那里用li标签添加即可。</li>',
		'type' => 'textarea');
    */
	...
	/*$options[] = array(
  	...
  	$options[] = array(
		'name' =>__('页面全屏查看图片模式', 'haoui').'(轻语博客加强版)',
		'id' => 'full_image',
		'desc' => __('开启', 'haoui'),
		'std' => true,
		'type' => "checkbox");
...
function _send_request($body, $method='POST'){
    $url = 'http://oauth.qyblog.cn/theme';
