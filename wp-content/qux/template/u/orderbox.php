...
<section class="pay-content clearfix">
    ...
    <div class="info-group clearfix">
        <div class="row clearfix">
			...
			$price = product_smallest_price($order_record->product_id);
            if($order_record->order_price == 0 || count(get_user_order_records($order_record->product_id,0,1))>0 && $order_record->order_status == 4){              
			if($dl_links){  
		...
		if($pay_content) { ?>
            ...
            <div class="col-md-9">
                <div class="form-control-static"><p><?php echo $pay_content; ?></p></div>
            </div>
        <?php   } 
            } 
		?>
