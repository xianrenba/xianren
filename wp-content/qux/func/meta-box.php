...
function um_video_info_callback($post) {
        ...
        <p style="clear:both;"><?php _e( '粘贴youku或者tudou的视屏url。例如： <br/>
				<code>https://v.youku.com/v_show/id_XMzE3MzgxOTE4OA==.html</code>或者<code>http://new-play.tudou.com/v/XMjg5NTU1ODAxMg==.html</code>', 'um' );?></p>
