			...
			<div class="comt-box">
				...
				<div class="comt-ctrl">
					...
					<div class="position">
		             ...
		             <?php if(is_user_logged_in()){ ?><a href="javascript:SIMPALED.Editor.img()" title="插图片"><b><i class="fa fa-image"></i></b></a><?php } ?>
		             <?php if(!wp_is_mobile()){ ?>
		             ...
		             <?php } ?>
					 <a href="javascript:SIMPALED.Editor.daka()" title="签到"><b><i class="fa fa-pencil-square-o"></i></b></a>
		            </div>
                   <?php }?>
				</div>
			</div>
