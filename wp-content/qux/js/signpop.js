...
return {
	init: function (){
		if(document.getElementById("qqlogin")){ 
		    var qq = document.getElementById('qqlogin');
		    var qqlogin = '\
		              <a class="login-qq" href="'+qq.href+'"><i class="fa fa-qq"></i> QQ帐号登录</a>\
		    '
		}else{
			var qqlogin = ''
		}
		if(document.getElementById("weibologin")){ 
		    var weibo = document.getElementById('weibologin');
		    var weibologin = '\
			               <a class="login-weibo" href="'+weibo.href+'"><i class="fa fa-weibo"></i> 微博帐号登录</a>\
			' 
		}else{
		    var weibologin = ''
		}
			...
			<div class="sign">\
			    ...
			    <div class="container">\
			        ...
			        <form id="sign-in"> \
			            ...
			            </div>'+(jsui.url_rp ? '<div class="sign-info"><a href="'+jsui.url_rp+'">找回密码？</a></div>' : '')+'<div class="sign-social">\
						'+qqlogin+'\
						'+weibologin+'\
						</div>\
						</form>\
