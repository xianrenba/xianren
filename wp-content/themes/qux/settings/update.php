...
function update_notifier_menu() {  
	$xml = get_latest_theme_version(1440); 
	$theme_data = wp_get_theme('qux'); 
...
function update_notifier() { 
	...
	<div class="wrap">
        ...
        <div id="instructions" style="max-width: 800px;">
            <h3>主题下载及更新：</h3>
            <p><strong>更新前：</strong>请先<strong>备份</strong>现有主题文件 <strong>/wp-content/themes/<?php echo $theme_data['Name']; ?>/</strong></p>
            <p>用你的账号登录到 <a target="_blank" href="https://www.qyblog.cn">qyblog.cn</a> 会员中心，在“订单管理”中找到该主题订单并下载主题zip压缩包。</p>
            <p>解压主题zip压缩包，使用FTP软件上传至服务器上的 <strong>/wp-content/themes/<?php echo $theme_data['Name']; ?>/</strong> 目录，替换所有文件。</p>
            <p>提示：更新主题过程中遇到问题请及时到 <a target="_blank" href="https://www.qyblog.cn">qyblog.cn</a> 留言得到技术支持。</p>
            <br>
            <p><a class="button-primary" target="_blank" href="https://www.qyblog.cn/2017/02/991.html">获取主题<?php echo $xml->latest; ?>版本<?php echo $cache;?></a>
        </div>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'https://www.qyblog.cn/themes/DUX/update/update.xml';
