...
switch ($ui['action']) {
	...
	case 'info':
		...
		$printr['user'] = array(
			...
			'weibo' => get_user_meta( $cuid, 'um_sina_weibo', true ),
            'description' => get_user_meta( $cuid, 'description', true )
		);
	...
	case 'info.edit':
        ...
        if( $ui['description'] ) update_user_meta($cuid, 'description', $ui['description']);
