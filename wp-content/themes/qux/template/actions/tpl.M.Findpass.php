...
<div id="signin">	
	<div class="part resetpass">
		...
		<form action="" method="post">
			<?php errormsg($errors); ?>
			<p>
				<label class="icon" for="pass1"><i class="fa fa-lock"></i></label>
				<input class="input-control"  type="password" placeholder="设置新密码" name="pass1" autofocus>
            </p>
            <p>
				<label class="icon" for="pass2"><i class="fa fa-retweet"></i></label>
				<input class="input-control"  type="password" placeholder="重复新密码" name="pass2">
            </p>
			<p>
