					...
					<div class="view-share">
						...
						<div class="bdshare">
							<div id="bdshare" class="shares"><span><?php _e('分享：','um'); ?></span>
								<a etap="share" data-share="weibo" class="bds_tsina share" title="<?php _e('分享到新浪微博','um'); ?>"></a>
								<a etap="share" data-share="qq" class="bds_sqq share"  title="<?php _e('分享到QQ好友','um'); ?>"></a>
								<a etap="share" data-share="qzone" class="bds_qzone share"  title="<?php _e('分享到QQ空间','um'); ?>"></a>
								<a href="javascript:;" data-url="<?php echo get_the_permalink(); ?>" class="bds_weixin wx_share share" title="<?php _e('分享到微信','um'); ?>"></a>
							</div>
						</div>
					</div>
				</div>
