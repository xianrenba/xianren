...
<?php if( _hui('user_page_s') ){ ?>
    <?php if( is_user_logged_in() && wp_is_mobile()):global $current_user; ?>
		...
		<li class="nav-user dropdown">
            ...
            <ul class="nav-user-menu dropdown-menu">
                ...
                <li><a href="<?php echo add_query_arg('redirect_to', _get_current_page_url(), _url_for('signout')); ?>"><i class="fa fa-power-off"></i>注销</a></li>
            </ul>
        </li>
	<?php else : ?>
