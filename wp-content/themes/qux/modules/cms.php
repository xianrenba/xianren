...
<?php
	...
	if(_hui('cmsundisplaycats') && is_array(_hui('cmsundisplaycats'))) $args['exclude'] = _hui('cmsundisplaycats');
 
	if(_hui('example_text') && is_array(_hui('example_text'))){
		foreach(_hui('example_text') as $catid){
