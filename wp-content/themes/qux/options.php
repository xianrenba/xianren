...
function optionsframework_options() {
	...
	foreach ($options_cat_obj as $cat) {
		$options_cat[$cat->cat_ID] = $cat->cat_name;
	}
	...
	foreach ($options_forum_terms as $forum) {
		$options_forum[$forum->cat_ID] = $forum->cat_name;
	}
	
	//专题分类循环
	$options_tcat = array();
	$options_tcat_terms = get_categories(array('taxonomy'=>'tcat','hide_empty'=>false));
	foreach ($options_tcat_terms as $tcat) {
		$options_tcat[$tcat->cat_ID] = $tcat->cat_name;
	}
	...
	$options[] = array(
		'name' => __('破解说明', 'haoui'),
		'id' => '破解说明',
		'desc' => __('如果觉得碍眼,可找到主题目录下/options.php文件，第'. __LINE__ .'行删除.两个网站:<a href="https://hostloc.com">hostloc</a>，，，，，<a href="https://zhuchunshu.com">更多破解主题</a>', 'haoui'),
		'std' => '主题名字：Qux,此破解版版本不会长期提供，请支持正版，尊重作者作品,破解项目发布地址:hostloc.com ->@Inkedus',
		'type' => 'textarea');
	...
	$options[] = array(
		...
		'id' => 'logo_src',
		'desc' => __('自行修改', 'haoui'),
		'std' => 'https://blog.zhuchunshu.cn/typecho/uploads/2020/06/1033574913.png',
		'type' => 'upload');
	...
	$options[] = array(
		'name' => __('自定义分享功能', 'haoui').' (v9.1.5+)',
		'id' => 'share_s',
		'type' => "checkbox",
		'std' => false,
		'desc' => __('开启  开启后使用下方自定义分享代码', 'haoui'));

	$options[] = array(
		'name' => __('自定义分享代码', 'haoui').' (v9.1.5+)',
		'id' => 'share_code',
...
*/
	...
	$options[] = array(
		...
		'desc' => __( '排除的分类将不会再CMS首页展现', 'haoui' ),
		'id' => 'cmsundisplaycats',
		'multiple' => true,
		'chosen' => true,
		'options' => $options_cat,
	...
	$options[] = array(
		...
		'desc' => __( '自定义首页CMS分类排序，CMS首页仅显示勾选分类，按勾选顺序排列', 'haoui' ),
		'id' => 'example_text',
		'multiple' => true,
		'chosen' => true,
		'placeholder' => __( '选择需要显示的分类', 'haoui' ),
		'options' => $options_cat,
		'type' => 'select'
	);
  	$options[] = array(
	...
	$options[] = array(
		...
		'desc' => __('适用于博客模式/卡片模式，CMS该设置无效', 'haoui'),
		'type' => 'select');
	...
	$options[] = array(
		'name' => __('首页列表置顶显示', 'haoui'),
		'std' => false,
		'id' => 'home_sticky_s',
		'desc' => __('开启后首页采用博客模式或卡片模式时，显示置顶文章在最前面', 'haoui'),
		'type' => 'checkbox');
	...
	$options[] = array(
		'name' => __('专题', 'haoui').$rrr.__('显示的分类', 'haoui'),
		'desc' => __( '勾选专题分类显示在首页，建议勾选4或者4的倍数', 'haoui' ),
		'id' => 'home_topic_cat',
		'multiple' => true,
		'chosen' => true,
		'options' => $options_tcat,
		'type' => 'select'
	);
	...
	$options[] = array(
		'name' => __('文章上一页下一页 - 网站外层', 'haoui'),
		'id' => 'post_prevnext_side',
		'type' => "checkbox",
		'std' => false,
		'desc' => __('开启', 'haoui'));	
...
/*
    ...
    */
	...
	$options[] = array(
		'name' => __('自定义公告分类', 'haoui'),
		'id' => 'notice_cat_s',
		'desc' => '开启该选项后可以选择一个文章分类显示而非公告',
		'std' => 'false',
		'type' => 'checkbox');
	...
	$options[] = array(
		'name' => __('按钮排序', 'haoui'),
		'id' => 'kefu_px',
		'desc' => '选择需要显示的以下按钮。默认排序：2 4 1',
		'std' => array(2,4,1),
		'multiple' => true,
		'chosen' => true,
		'options' => $kefu_options,
		'type' => 'select');
	...
	$options[] = array(
		...
		'id' => 'bdtui_on',
		'std' => false,
		'desc' => ' 开启'.' （开启后发布或编辑文章时会主动提交到链接至百度，默认为普通收录，在文章可勾选快速收录）',
		'type' => 'checkbox');
	...
	$options[] = array(
		...
		'id' => 'baidu_tui_url',
		'std' => '',
		'desc' => '在搜索资源平台验证的站点，比如www.example.com',
		'type' => 'text'); 
