...
<div class="box mar10-b">
	<div id="user-cover" class="user-cover pos-r" :style="'overflow:'+(toolShow ? 'inherit;' : 'hidden')">
		...
		<div :class="[{'cover-index':toolShow},'cover-tool','fs12','pd10','pos-a','st1431']" v-show="toolShow" v-cloak>
	...
	<div id="user-avatar" class="user-avatar pos-r">
		...
		<div class="user-info pd20">
			<h1 class="l1">
				<?php echo esc_attr($user_data->display_name); ?><span class="h1-lv fs13 mar10-l"><?php echo zrz_get_lv($user_id,'name'); ?></span>
			</h1>
