		...
		<?php
    		...
    		$option->table( array(
                ...
                array(
                    ...
                    'after' => '<p>请输入 logo 图片的 url，如果不想使用图片 logo 此项请留空，<br>默认：<code>'.ZRZ_THEME_URI.'/images/logo.svg</code>（LOGO比例 140/34 。推荐使用SVG格式的LOGO。）</p>',
    				'key' => 'logo',
                ...
                // array(
    			// 	'type' => 'input',
    			// 	'th' => __('长微博图片中的LOGO','ziranzhi2'),
                //     'after' => '<p>文章长微博的右下角会有自己的Logo标识，请设置您的LOGO地址(不支持 svg 格式，必须是 png 或者 jpg 或者 gif 并且背景不能是透明的，请注意)。<br>例如：<code>'.ZRZ_THEME_URI.'/images/logo-w.png</code></p>',
    			// 	'key' => 'logo_w',
    			// 	'value' => zrz_get_theme_settings('logo_w')
    			// ),
    			array(
    				'type' => 'input',
