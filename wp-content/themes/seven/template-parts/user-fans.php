...
?>
<div id="user-follow">
    <div class="box-header pd10 b-b" ref="listFollow" data-type="zrz_followed">关注<span v-text="uName"></span>的人</div>
    ...
    <template v-else-if="list.length > 0">
        ...
        <page-nav class="b-t" :nav-type="'userFans'" :paged="paged" :pages="pages" :locked-nav="1"></page-nav>
    </template>
    <div class="loading-dom pos-r" v-else v-cloak><div class="lm"><i class="iconfont zrz-icon-font-wuneirong"></i><p class="mar10-t">没有人关注我</p></div></div>
</div>
