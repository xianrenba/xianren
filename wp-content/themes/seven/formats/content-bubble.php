<?php
    ...
    $count = count($love);
?>
<div class="bubble-list-item box mar10-b" id="bubbleList<?php echo $post_id; ?>">
    ...
    <div class="bubble-content-meta pd10 pos-r clearfix">
        ...
        <div class="t-c bubble-more-content fr"><button class="bubble-show empty small">阅读全部</button><button class="bubble-hide empty small">点击收起</button></div>
    </div>
    ...
    <div class="bubble-like-box">
        <div class="pd10 bg-b">
            <button class="text bubble-like-button-ac"><i class="iconfont <?php echo $loved == 1 ? 'zrz-icon-font-love' : 'zrz-icon-font-xihuan'; ?>"></i>喜欢</button>
