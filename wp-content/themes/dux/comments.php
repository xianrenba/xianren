...
<div id="respond" class="no_webshot">
	...
	<div class="comment-signarea">
		...
		<p>
			...
			<a rel="nofollow" href="../wp-login.php?action=register" class="btn btn-default signup-loader">注册</a>
		</p>
	</div>
				...
				<?php 
					if ( is_user_logged_in() ) {
						...
						if ( !empty($comment_author) ){
							...
							echo '<p><a rel="nofollow" href="javascript:;" class="comment-user-change">更换</a></p>';
						}
					}
				?>
