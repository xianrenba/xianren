...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'std' => 'http://www.wuzuowei.net/logo4.png',
		'type' => 'upload');
...
with(document)0[(getElementsByTagName("head")[0]||body).appendChild(createElement("script")).src="http://www.wuzuowei.net/static/api/js/share.js?cdnversion="+~(-new Date()/36e5)];
</script>',
		'desc' => __('升级版百度分享代码，完美支持HTTPS网站', 'haoui'),
		'settings' => array(
			'rows' => 8
		),
		'type' => 'textarea');
