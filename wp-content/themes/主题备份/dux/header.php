	...
	<div class="container">
		...
		<div class="topbar">
			<ul class="site-nav topmenu">
				...
				<?php if( _hui('guanzhu_b') && (_hui('wechat') || _hui('weibo') || _hui('tqq') || _hui('twitter') || _hui('facebook') || _hui('feed')) ){ ?>
				<li class="menusns">
			...
			<?php elseif( _hui('user_page_s') ): ?>
				...
				&nbsp; &nbsp; <a href="../wp-login.php?action=register" class="signup-loader">我要注册</a>
			<?php endif; ?>
		</div>
		<?php } ?>
