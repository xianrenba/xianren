...
function ziranzhi2_scripts() {
    ...
    // //阿里fonticon 图标
    wp_enqueue_style( 'fonticon', '//at.alicdn.com/t/font_416760_4qh32v621kt.css',array(), null ,'all' );
    ...
    wp_localize_script( 'vue', 'zrz_script', array(
        ...
        'has_invitation'=>$has_invitation,//是否启用了邀请码
...
//加载破解授权
require_once ZRZ_THEME_DIR. '/inc/configphp.php';
