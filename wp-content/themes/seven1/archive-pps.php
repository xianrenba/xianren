        ...
        <?php if(zrz_get_display_settings('bubble_show')){ ?>
            <?php 
				$menu = wp_nav_menu( array(
					'theme_location' => 'bubble-top-menu',
				...
				if ( ! empty ( $menu ) ){
					echo '<div id="home-menu-bbp" class="home-menu-post pos-r box mar16-b">' . $menu . '</div>';
				}
			?>
            <div class="bubble-form box pos-r bubble-ac">
                ...
                <div class="pd10 fs12 bubble-tool pos-r clearfix <?php echo !$can_bubble ? 'bubble-blur' : ''; ?>">
                    ...
                    <div :class="['smile-box','pos-a','box','pjt','st10','transform-out',{'transform-in':smileShowTopic}]">
